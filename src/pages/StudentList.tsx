  ...
  return (
    <Card className="grow">
      <CardHeader className="flex flex-row flex-wrap gap-x-[clamp(0.5rem,0.5rem+1vw,1rem)] items-center justify-between">
        ...
        <CardDescription
          className={
            "text-[clamp(0.75rem,0.75rem+1vh,1rem)] flex flex-row flex-wrap gap-x-[clamp(0.25rem,0.25rem+1vw,0.5rem)] items-center max-sm:items-start text-wrap"
          }
        >
      ...
      <CardFooter
        className={
          "text-[clamp(0.75rem,0.75rem+1vh,1rem)] flex flex-row flex-wrap gap-x-[clamp(0.25rem,0.25rem+1vw,0.5rem)] items-center justify-center max-sm:items-start text-wrap"
        }
      >
        <FolderSync className={"size-[clamp(0.75rem,0.75rem+1vh,1rem)]"} />
        Las asistencias se guardan automáticamente.
